...
if __name__ == "__main__":
    ...
    df = pd.read_csv('extracted_data//after_data_types_fixing.csv')
    ...
    # Save train-test split directly in the 'extracted' folder
    X_train.to_csv("D:\Github\Linear_Regression_A-Z\extracted_data\X_train.csv", index=False)
    X_test.to_csv("D:\Github\Linear_Regression_A-Z\extracted_data\X_test.csv", index=False)
    y_train.to_csv("D:\Github\Linear_Regression_A-Z\extracted_data\y_train.csv", index=False)
    y_test.to_csv("D:\Github\Linear_Regression_A-Z\extracted_data\y_test.csv", index=False)

    print("Train-test split data saved successfully in 'extracted' folder.")
